...
while True:
  try:
    ...
    print(f'{hijau} Gcast berhasil.! {putih}gcast by : iruz')
    sleep(70)
    client.send_message(entity=channel_entity, message='.gcast  ?????? ?????????? ????????????? ?????? ')
    print(f'{hijau} Gcast berhasil.! {putih}gcast by : iruz')
    sleep(70)
    client.send_message(entity=channel_entity, message='.gcast  Enak bnget omck ny aahtt? ')
    print(f'{hijau} Gcast berhasil.! {putih}gcast by : iruz')
    sleep(70)
    client.send_message(entity=channel_entity, message='.gcast  ?????? ????????? ?????? ¦Â¦Â??????? ??????? ??????? ?????? ?? ¦Â????? ')
    print(f'{hijau} Gcast berhasil.! {putih}gcast by : iruz')
    sleep(70)
    client.send_message(entity=channel_entity, message='.gcast  ?????? ?????????? ????????????? ?????? ')
    print(f'{hijau} Gcast berhasil.! {putih}gcast by : iruz')
    sleep(70)
    client.send_message(entity=channel_entity, message='.gcast  ???? ????? ??? ???3? ??????_ ??? ????1???? ')
    print(f'{hijau} Gcast berhasil.! {putih}gcast by : iruz')
    sleep(70)
    ...
    print(f'{hijau} Gcast berhasil.! {putih}gcast by : iruz')
    sleep(70)
    client.send_message(entity=channel_entity, message='.gcast  ???? ????? ??? ???????? ??????33 ??? ????? ????????????? ')
    print(f'{hijau} Gcast berhasil.! {putih}gcast by : iruz')
    sleep(70)
    ...
    print(f'{hijau} Gcast berhasil.! {putih}gcast by : iruz')
    sleep(70)
    client.send_message(entity=channel_entity, message='.gcast  ??? ???33 ???????? ???? ????? s???? ')
    print(f'{hijau} Gcast berhasil.! {putih}gcast by : iruz')
    sleep(70)
...
???????? ????????? ')
    ...
    print(f'{hijau} Gcast berhasil.! {putih}gcast by : iruz')
    sleep(70)
    client.send_message(entity=channel_entity, message='.gcast  ??????? ??? ????????? ???69 ????????? ????? ???????????? ')
    print(f'{hijau} Gcast berhasil.! {putih}gcast by : iruz')
    sleep(70)
